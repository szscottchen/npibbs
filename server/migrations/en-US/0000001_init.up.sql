...
(9, 2, 'menu', 'UserList', 'User List', 'icon-list', '/user', 'user/index', 1, 0, (UNIX_TIMESTAMP(now()) * 1000), (UNIX_TIMESTAMP(now()) * 1000)),
(27, 2, 'func', '', 'Edit', '', '', NULL, 2, 0, (UNIX_TIMESTAMP(now()) * 1000), (UNIX_TIMESTAMP(now()) * 1000)),
...
-- Add user list menu permission for admin role
INSERT INTO `t_role_menu` (`role_id`, `menu_id`, `create_time`) VALUES
(2, 9, (UNIX_TIMESTAMP(now()) * 1000));