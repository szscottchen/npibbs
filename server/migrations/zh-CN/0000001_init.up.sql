...
(9, 2, 'menu', 'UserList', '用户列表', 'icon-list', '/user', 'user/index', 1, 0, (UNIX_TIMESTAMP(now()) * 1000), (UNIX_TIMESTAMP(now()) * 1000)),
(27, 2, 'func', '', '编辑', '', '', NULL, 2, 0, (UNIX_TIMESTAMP(now()) * 1000), (UNIX_TIMESTAMP(now()) * 1000)),
