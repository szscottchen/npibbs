...
// 积分来源类型
const (
	ScoreSourcePostTopic   = "post_topic"   // 发帖
	ScoreSourcePostComment = "post_comment" // 跟帖
	ScoreSourceCheckIn     = "check_in"     // 签到
	ScoreSourceValue       = "value"        // 价值
)

// 系统配置类型
const (
	SysConfigValueTypes = "valueTypes" // 价值类型配置
)
