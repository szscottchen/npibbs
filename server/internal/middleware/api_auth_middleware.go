...
var (
	authCfg = []PathRole{
		...
		{Pattern: "/api/admin/user/batch-import", Roles: []string{constants.RoleOwner}},
		{Pattern: "/api/admin/user/download-template", Roles: []string{constants.RoleOwner, constants.RoleAdmin}},
