            ...
            >
              ...
              >
                <li v-for="(image, index) in topic.imageList" :key="image.url">
                  <div class="image-item" v-if="isImageFile(image.url)">
                    <el-image
                      :src="image.preview"
                  ...
                  <div class="file-item" v-else @dblclick="openFile(image.url)">
                    <i class="file-icon" :class="getFileIconClass(image.url)"></i>
                    <span class="file-name">{{ getFileName(image.url) }}</span>
                  </div>
                </li>
              </ul>
              <div
