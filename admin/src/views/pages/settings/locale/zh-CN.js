  ...
  settings: {
    ...
    upload: {
      ...
      placeholder: {
        ...
        uploadPath: '请输入上传目录路径，无论什么平台使用正斜杠',
        maxSizeMB: '请输入文件大小限制（MB）',
      },
      uploadPathHelp: '所有平台上文件目录都使用正斜杠',
      maxSizeMBHelp: '单个文件的最大大小限制（单位：MB）',
      message: {
        submitSuccess: '提交成功',
      },
    },
    topic: {
      ...
      types: {
        ...
        validation: {
          valueRequired: '类型值不能为空',
          labelRequired: '类型标签不能为空',
          valueExists: '类型值已存在',
        },
      },
      valueTypes: {
        ...
        validation: {
          labelRequired: '价值标签不能为空',
          scoreRequired: '积分值必须大于0',
        },
      },
      submit: '提交',
      message: {
