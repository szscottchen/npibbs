  ...
  settings: {
    ...
    upload: {
      ...
      placeholder: {
        ...
        uploadPath: 'Enter upload directory path, use forward slash regardless platform',
        maxSizeMB: 'Enter file size limit (MB)',
      },
      uploadPathHelp: 'Use forward slashes for file directories on all platforms',
      maxSizeMBHelp: 'Maximum file size limit (unit: MB)',
      message: {
    ...
    topic: {
      ...
      types: {
        ...
        placeholder: {
          ...
          label: 'Please enter type label',
          description: 'Please enter type description',
          color: 'Please select color',
          icon: 'Please enter icon class name',
        },
        validation: {
          valueRequired: 'Type value is required',
          labelRequired: 'Type label is required',
          valueExists: 'Type value already exists',
        },
      },
      valueTypes: {
        title: 'Value Types Configuration',
        item: 'Value Type',
        addType: 'Add Value Type',
        removeType: 'Remove Type',
        label: 'Label',
        score: 'Score',
        placeholder: {
          label: 'Please enter value label',
          score: 'Please enter score value',
        },
        validation: {
          labelRequired: 'Value label is required',
          scoreRequired: 'Score value must be greater than 0',
        },
      },
      submit: 'Submit',
      message: {
