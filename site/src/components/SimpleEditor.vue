...
<template>
  <div class="simple-editor">
    <div class="simple-editor-toolbar">
      <div class="act-btn">
        <i class="iconfont icon-file" @click="switchImageUpload" />
      </div>
    ...
    <div v-show="showImageUpload" class="simple-editor-image-upload">
      <image-upload
        ...
        accept="image/jpeg,image/png,image/gif,image/bmp,image/webp,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.pdf,.txt,.zip,.rar"
