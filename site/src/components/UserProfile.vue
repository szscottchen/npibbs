    ...
    <div class="profile-info">
      <div class="metas">
        <div class="nickname-container">
          ...
          <div v-if="localUser && localUser.isDefaultPassword" class="default-password-warning">
            初始密码未修改，请在&lt;编辑资料&gt;-&lt;账号设置&gt;功能中修改
          </div>
        </div>
...
.dark-mode {
  ...
  .nickname-container .default-password-warning {
    color: #ff5555; // 深色主题下的警告色
  }
}
</style>
